...
var bombasTotal;
var vidaPlaneta,barraPlaneta,barraInimigos,cont;
var ie,isom,isomTiro;
var cont;
...
function criaBomba(){
	if(jogo){
		...
		contBombas--;  // Decremento das Bombas
	}
}
function controlaBomba(){
	...
	for(var i=0;i<tam;i++){
		if(bombasTotal[i]){
			...
			if(pi>tamTelaH){
				vidaPlaneta-=10;  // Decremento da Vida do Planeta
...
function atira(x,y){
	...
	var somTiro=document.createElement("audio"); // Audio
	var att1=document.createAttribute("class");
	var att2=document.createAttribute("style");
	var att5=document.createAttribute("src"); // Audio
	...
	somTiro.setAttributeNode(att5); // Audio
	somTiro.setAttributeNode(att6); // Audio
	t.appendChild(somTiro); // Audio
	document.body.appendChild(t);
	document.getElementById("somTiro"+isomTiro).play(); //Audio
	isomTiro++; //Audio
}
...
function gerenciaGame(){
	...
	barraInimigos.style.width=cont+"px";
	if(cont<=0){
		jogo=false;
...
function reinicia(){
	...
	jog.style.top=pjy+"px";
	jog.style.left=pjx+"px";
	contBombas=300; // Quantidade de Bombas
	jogo=true;
...
function inicia(){
	...
	contBombas=300;  // Quantidade de Bombas
	velB=3; // Velocidade das Bombas
	barraInimigos=document.getElementById("barraInimigos");
	barraInimigos.style.width=cont+"px";
